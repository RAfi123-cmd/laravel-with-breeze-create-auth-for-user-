...
class ManageOrderController extends Controller
{
    ...
    public function AllClientOrders()
    {
        ...
        $orderItemGroupData = OrderItem::with(['product', 'order'])->where('client_id', $clientId)->orderBy('order_id', 'desc')->get()->groupBy('order_id');
    ...
    public function UserInvoiceDownload($id)
    {
        ...
        $pdf = Pdf::loadView(
            'frontend.dashboard.order.invoice_download',
            compact('order', 'orderItem', 'totalPrice')
