                        ...
                        <form id="myForm" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-check mt-2">
                                    <input type="checkbox" class="form-check-input" name="best_seller" id="formCheck2" value="1" {{ $product->best_seller == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="formCheck2">Best Seller</label>
                                </div>
                                <div class="form-check mt-2">
                                    <input type="checkbox" class="form-check-input" name="most_populer" id="formCheck2" value="1" {{ $product->most_populer == 1 ? 'checked' : '' }}>
