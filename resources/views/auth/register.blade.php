                     ...
                     <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                           ...
                           <div class="form-label-group">
                              <input type="name" name="name" id="ptext" class="form-control" placeholder="Email address">
                           ...
                           <div class="form-label-group">
                              <input type="password" name="password_confirmation" id="inputPassword1" name="password" class="form-control" placeholder="Password">
